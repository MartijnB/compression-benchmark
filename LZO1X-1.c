...
#include "lzo-2.09/include/lzo/lzo1x.h"
...
int main(int argc, char *argv[]) {
    ...
    void* wrkmem = malloc(LZO1X_1_11_MEM_COMPRESS);

    gettimeofday(&time_start, NULL);
    lzo1x_1_11_compress(inpbuffer, (unsigned int) file_size, outbuffer, &compressed_size, wrkmem);
